...
namespace duckdb{
CSVBufferManager::CSVBufferManager(ClientContext &context_p, CSVFileHandle &file_handle_p): context(context_p), file_handle(file_handle_p){
	cached_buffers.emplace_back(make_shared<CSVBuffer>(context, CSVBuffer::CSV_BUFFER_SIZE,file_handle,
                     global_csv_pos, 0));
